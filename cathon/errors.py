...
def _string_with_arrows(
  text, pos_start, pos_end, error_pos_start=None, error_pos_end=None
):
...
class SyntaxError(BaseError):
  def __init__(
    ...
    pos_start,
    pos_end,
    details: str = 'invalid syntax',
    error_pos_start=None,
    error_pos_end=None,
  ):
    super().__init__(
      pos_start, pos_end, 'SyntaxError', details, error_pos_start, error_pos_end
    )


class IndentationError(BaseError):
  def __init__(
    self, pos_start, pos_end, details: str, error_pos_start=None, error_pos_end=None
  ):
    super().__init__(
      pos_start, pos_end, 'IndentationError', details, error_pos_start, error_pos_end
    )
...
class RuntimeError(BaseError):
  def __init__(
    ...
    super().__init__(
      pos_start, pos_end, error_name, details, error_pos_start, error_pos_end
    )
...
class NameError(RuntimeError):
  def __init__(
    ...
    super().__init__(
      pos_start, pos_end, details, context, 'NameError', error_pos_start, error_pos_end
    )
...
class TypeError(RuntimeError):
  def __init__(
    ...
    super().__init__(
      pos_start, pos_end, details, context, 'TypeError', error_pos_start, error_pos_end
    )
...
class IndexError(RuntimeError):
  def __init__(
    ...
    super().__init__(
      pos_start, pos_end, details, context, 'IndexError', error_pos_start, error_pos_end
    )
...
class KeyError(RuntimeError):
  def __init__(
    ...
    super().__init__(
      pos_start, pos_end, details, context, 'KeyError', error_pos_start, error_pos_end
    )
